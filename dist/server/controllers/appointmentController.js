...
export async function submitPostVisit(req, res) {
    try {
    ...
    `;
        sendEmailNotification(appointment.patient.email, 'APPOINTMENT_REMINDER', `Your Post-Visit Summary from Dr. ${appointment.doctor.user.name}`, emailBody);
        return res.json({
