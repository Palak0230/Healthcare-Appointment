...
export async function sendEmailNotification(recipientEmail, type, subject, htmlContent) {
    let status = 'SENT';
...
export async function retryFailedNotifications() {
    ...
    for (const log of failedLogs) {
        ...
        const success = await sendEmailNotification(log.recipientEmail, log.type, `[Retry] ${log.subject}`, `<p>This is a re-sent notification.</p><p>Original Subject: ${log.subject}</p>`);
